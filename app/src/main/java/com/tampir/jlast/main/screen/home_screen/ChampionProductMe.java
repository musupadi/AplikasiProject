...
public class ChampionProductMe extends BaseChildFragment {
    View fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (fragment==null){
            fragment = inflater.inflate(R.layout.main_screen_champion_me, null);
    ...
    private void loadData(final boolean next){
        ...
        if (user!=null && Connectivity.isConnected(getContext())) {
            String urlParameters = new ParameterHttpPost()
                    ...
                    .build();
            mAuthTask = new HttpConnection.Task(HttpConnection.METHOD_POST, "ProductListMe", urlParameters, new HttpConnection.OnTaskFinishListener() {
                @Override
                public void onStart() {
                    ...
                    if (err == null) {
                        ...
                        if (items.size() > 0 && items.get(items.size() - 1) == null) {
                            ...
                            if (cj.get("data", 0) == null) {
                                lbPlaceholder.setText("Kamu belum menukarkan poin card dengan product");
                            }
                        }
