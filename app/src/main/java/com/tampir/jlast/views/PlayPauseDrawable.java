...
public class PlayPauseDrawable extends Drawable {
    ...
    public PlayPauseDrawable(Context context) {
        ...
        /*
        mPauseBarWidth = LibFunction.dpToPx(8);
        mPauseBarHeight = LibFunction.dpToPx(24);
        mPauseBarDistance = LibFunction.dpToPx(8);
        */
        mPauseBarWidth = LibFunction.dpToPx(6);
        mPauseBarHeight = LibFunction.dpToPx(18);
        mPauseBarDistance = LibFunction.dpToPx(6);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        final float barWidth = lerp(mPauseBarWidth, mPauseBarHeight / 1.8f, mProgress);
