...
public class Connectivity {
    ...
    public static String ConnectionName(Context context){
        NetworkInfo info = Connectivity.getNetworkInfo(context);
        return Connectivity.ConnectionName(info.getType(),info.getSubtype());
    }
    public static String ConnectionName(int type, int subType){
        if(type== ConnectivityManager.TYPE_WIFI){
            return "TYPE_WIFI";
        }else if(type== ConnectivityManager.TYPE_MOBILE){
            switch(subType){
